    ...
    <!-- FORM TAMBAH DATA -->
            <form action="submit.php" method="post">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" maxlength="30" class="form-control" name="nis" placeholder="Nomor Induk Siswa" required>
                    </div>
                </div>
                ...
                <button onclick="window.location.href='data-user.php';" type="submit" name="cancel"class="btn btn-danger">CANCEL</button>
            </form>
            <!--JQUERY-->
